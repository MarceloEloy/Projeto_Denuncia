...
import com.projectP4.ProjetoDenuncia.Infra.TokenService;
import com.projectP4.ProjetoDenuncia.Model.DTO.LoginResponseDTO;
...
public class UserController {
    ...
    public ResponseEntity login(@RequestBody UserDTO dto){
        ...
        return ResponseEntity.ok().body(new LoginResponseDTO(token).token());
    }
